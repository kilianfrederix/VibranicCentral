...
const common: Common = {
  ...
  areYouSureYouWantToDelete : 'Weet je zeker dat je dit wilt verwijderen?',
  currencies: 'Valuta',
  currency: 'Valuta',
};

const home: Home = {
  AvailableApps: 'Beschikbare apps',
  welcome: 'Welkom',
  open: 'open',
};

const BudgetWise: BudgetWise = {
  BudgetWise: 'Budget Wise',
};

const FocusFlow: FocusFlow = {
  FocusFlow: 'Focus Flow',
};

const CleanCrew: CleanCrew = {
  CleanCrew: 'Clean Crew',
};

const VibeLink: VibeLink = {
  VibeLink: 'Vibe Link',
};

const Eventure: Eventure = {
  Eventure: 'Eventure',
};

const RecipeRiot: RecipeRiot = {
